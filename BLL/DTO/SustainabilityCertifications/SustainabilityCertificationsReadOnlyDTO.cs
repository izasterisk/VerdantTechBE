...
public class SustainabilityCertificationsReadOnlyDTO
{
    ...
    // [StringLength(255, ErrorMessage = "Tên tổ chức cấp chứng chỉ không được vượt quá {1} ký tự")]
    public string? IssuingBody { get; set; }

    // [StringLength(5000, ErrorMessage = "Mô tả không được vượt quá {1} ký tự")]
...
public class SustainabilityCertificationsCategoryReadOnlyDTO
{
    public string Name { get; set; } = string.Empty;
}