...
public interface IChatbotConversationService
{
    ...
    Task<ChatbotConversationsResponseDTO> UpdateChatbotConversationAsync(ulong conversationId, ChatbotConversationUpdateDTO dto, CancellationToken cancellationToken = default);
