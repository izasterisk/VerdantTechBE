...
-- Insert Transactions (UPDATED: Centralized transaction ledger replacing wallet_transactions and payouts)
INSERT INTO `transactions` (`Id`, `user_id`, `order_id`, `Type`, `amount`, `Status`, `transaction_date`, `description`, `payment_method`, `external_transaction_id`, `metadata`, `created_at`, `updated_at`) VALUES
(1, 5, 1, 'payment', 23000000.00, 'completed', '2025-08-20 11:30:00', 'Payment for order #1 - Máy cày', 'vnpay', 'VNP_TX_20250820001', '{"gateway": "vnpay", "reference": "VNP20250820001"}', '2025-08-20 11:30:00', '2025-08-20 11:30:00'),
(2, 6, 2, 'payment', 1483500.00, 'completed', '2025-08-21 09:15:00', 'Payment for order #2 - Hạt giống và phân bón', 'momo', 'MOMO_TX_20250821001', '{"gateway": "momo", "reference": "MOMO20250821001"}', '2025-08-21 09:15:00', '2025-08-21 09:15:00'),
(3, 7, 3, 'payment', 11240000.00, 'pending', '2025-08-21 11:00:00', 'Payment for order #3 - Drone phun thuốc', 'bank_transfer', 'BANK_TX_20250821001', '{"gateway": "bank", "account": "VCB123456789"}', '2025-08-21 11:00:00', '2025-08-21 11:00:00'),
(4, 1, NULL, 'commission', 2000000.00, 'completed', '2025-08-24 15:00:00', 'Commission from sale of product #1', 'platform_credit', 'COMM_20250824001', '{"commission_rate": 8, "product_id": 1, "sale_amount": 25000000}', '2025-08-24 15:00:00', '2025-08-24 15:00:00'),
(5, 2, NULL, 'commission', 147000.00, 'completed', '2025-08-21 16:00:00', 'Commission from sale of products #3 and #4', 'platform_credit', 'COMM_20250821001', '{"commission_rate": 5.5, "products": [3,4], "sale_amount": 2490000}', '2025-08-21 16:00:00', '2025-08-21 16:00:00');
...
-- Insert Products (UPDATED: Removed vendor_id, products now belong to company)
...
(1, 2, 'TC001', 'Máy Cày Mini Điện VerdantTech V1', 'VerdantTech V1 Electric Mini Tractor', 'may-cay-mini-dien-verdanttech-v1', 'Máy cày mini điện thân thiện môi trường, phù hợp cho ruộng nhỏ và vườn gia đình', 'Eco-friendly electric mini tractor suitable for small fields and home gardens', 25000000.00, 18000000.00, 8.00, 10.00, '["EcoLabel", "EnergyStar"]', 'A+++', '{"power": "2000W", "battery": "48V 100Ah", "speed": "0-8km/h", "working_width": "80cm"}', '["manual-tc001-vi.pdf", "manual-tc001-en.pdf"]', '["tc001-1.jpg", "tc001-2.jpg", "tc001-3.jpg"]', 24, 50, 150.500, '{"length": 120, "width": 85, "height": 90}', 1, 1, 245, 12, 4.50, 8, '2025-08-20 08:00:00', '2025-08-21 07:00:00'),
(2, 3, 'HV001', 'Máy Gặt Lúa Thông Minh EcoHarvest', 'EcoHarvest Smart Rice Harvester', 'may-gat-lua-thong-minh-ecoharvest', 'Máy gặt lúa tự động với công nghệ thông minh, tiết kiệm năng lượng', 'Automatic rice harvester with smart technology and energy-saving features', 85000000.00, 70000000.00, 12.00, 5.00, '["GreenTech", "CarbonNeutral"]', 'A++', '{"power": "15kW", "capacity": "0.5ha/h", "grain_tank": "500kg", "cutting_width": "120cm"}', '["manual-hv001-vi.pdf"]', '["hv001-1.jpg", "hv001-2.jpg"]', 36, 20, 850.000, '{"length": 320, "width": 150, "height": 200}', 1, 1, 156, 5, 4.80, 4, '2025-08-20 08:30:00', '2025-08-21 06:30:00'),
(3, 5, 'OFC001', 'Phân Compost Hữu Cơ Premium', 'Premium Organic Compost', 'phan-compost-huu-co-premium', 'Phân compost 100% hữu cơ từ phế phẩm nông nghiệp, giàu dinh dưỡng', '100% organic compost from agricultural waste, nutrient-rich', 150000.00, 80000.00, 5.00, 0.00, '["OrganicCert", "EcoFriendly"]', NULL, '{"organic_matter": "85%", "nitrogen": "2.5%", "phosphorus": "1.8%", "potassium": "2.2%"}', '["huong-dan-su-dung-compost.pdf"]', '["ofc001-1.jpg", "ofc001-2.jpg"]', 0, 500, 25.000, '{"length": 50, "width": 30, "height": 20}', 0, 1, 1250, 87, 4.70, 12, '2025-08-20 09:00:00', '2025-08-21 05:00:00'),
(4, 7, 'VS001', 'Hạt Giống Cà Chua Hữu Cơ F1', 'F1 Organic Tomato Seeds', 'hat-giong-ca-chua-huu-co-f1', 'Hạt giống cà chua lai F1 chất lượng cao, năng suất cao, kháng bệnh tốt', 'High-quality F1 hybrid tomato seeds, high yield, good disease resistance', 85000.00, 45000.00, 6.00, 15.00, '["OrganicCert"]', NULL, '{"germination_rate": "95%", "days_to_harvest": "75-80", "fruit_weight": "150-200g", "disease_resistance": ["mosaic", "wilt"]}', '["huong-dan-gieo-trong.pdf"]', '["vs001-1.jpg", "vs001-2.jpg"]', 0, 200, 0.050, '{"length": 10, "width": 6, "height": 1}', 1, 1, 890, 45, 4.60, 8, '2025-08-20 09:30:00', '2025-08-21 04:30:00'),
(5, 8, 'IS001', 'Hệ Thống Tưới Nhỏ Giọt Thông Minh', 'Smart Drip Irrigation System', 'he-thong-tuoi-nho-giot-thong-minh', 'Hệ thống tưới nhỏ giọt tự động với cảm biến độ ẩm đất', 'Automatic drip irrigation system with soil moisture sensors', 12000000.00, 8500000.00, 10.00, 8.00, '["WaterSaver", "SmartTech"]', 'A+', '{"coverage": "1000m2", "sensors": "5", "timer": "programmable", "water_saving": "60%"}', '["manual-is001-vi.pdf", "installation-guide.pdf"]', '["is001-1.jpg", "is001-2.jpg", "is001-3.jpg"]', 18, 30, 45.500, '{"controller_length": 30, "controller_width": 20, "controller_height": 15, "pipes_length": 500, "emitters_count": 100}', 1, 1, 423, 18, 4.40, 5, '2025-08-20 10:00:00', '2025-08-21 04:00:00');
...
-- Insert Orders (UPDATED: Removed vendor_id, orders now only have customer_id)
...
(1, 5, 'delivered', 25000000.00, 0.00, 500000.00, 2500000.00, 23000000.00, '{"name": "Phạm Văn Khách Hàng 1", "phone": "0901234571", "address": "123 Đường ABC, Quận 1, TP.HCM"}', 'express', 'VDT2025082001', 'Giao hàng vào buổi sáng', NULL, NULL, '2025-08-20 11:00:00', '2025-08-22 08:00:00', '2025-08-24 14:30:00', '2025-08-20 10:00:00', '2025-08-24 14:30:00'),
(2, 6, 'shipped', 1716750.00, 0.00, 50000.00, 283250.00, 1483500.00, '{"name": "Hoàng Thị Khách Hàng 2", "phone": "0901234572", "address": "456 Đường XYZ, Quận 2, TP.HCM"}', 'standard', 'VDT2025082002', 'Cần gói cẩn thận', NULL, NULL, '2025-08-21 10:00:00', '2025-08-21 15:00:00', NULL, '2025-08-21 09:00:00', '2025-08-21 15:00:00'),
(3, 7, 'confirmed', 12000000.00, 0.00, 200000.00, 960000.00, 11240000.00, '{"name": "Nguyễn Văn Nông Dân 1", "phone": "0901234573", "address": "789 Đường Nông Thôn, Đồng Nai"}', 'express', NULL, 'Cần hỗ trợ lắp đặt', NULL, NULL, '2025-08-21 11:30:00', NULL, NULL, '2025-08-21 11:00:00', '2025-08-21 11:30:00');

-- Insert Purchase Inventory (NEW TABLE)
INSERT INTO `purchase_inventory` (`Id`, `product_id`, `supplier_id`, `quantity_ordered`, `quantity_received`, `unit_cost`, `total_cost`, `purchase_date`, `received_date`, `Status`, `Notes`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 5, 5, 18000000.00, 90000000.00, '2025-08-15 09:00:00', '2025-08-20 10:00:00', 'received', 'Máy cày đầu tiên nhập kho', '2025-08-15 09:00:00', '2025-08-20 10:00:00'),
(2, 2, 2, 10, 10, 70000000.00, 700000000.00, '2025-08-16 14:00:00', '2025-08-21 16:00:00', 'received', 'Hệ thống tưới nhập kho', '2025-08-16 14:00:00', '2025-08-21 16:00:00'),
(3, 3, 1, 20, 15, 80000.00, 1600000.00, '2025-08-17 11:00:00', '2025-08-22 15:00:00', 'partial', 'Thiếu 5 cái, chờ lô tiếp theo', '2025-08-17 11:00:00', '2025-08-22 15:00:00'),
(4, 4, 2, 8, 0, 45000.00, 360000.00, '2025-08-18 08:00:00', NULL, 'pending', 'Chờ giao hàng từ nhà cung cấp', '2025-08-18 08:00:00', '2025-08-18 08:00:00'),
(5, 5, 1, 3, 3, 8500000.00, 25500000.00, '2025-08-19 10:00:00', '2025-08-23 09:00:00', 'received', 'Drone phun thuốc nhập kho', '2025-08-19 10:00:00', '2025-08-23 09:00:00');

-- Insert Sales Inventory (NEW TABLE)
INSERT INTO `sales_inventory` (`Id`, `product_id`, `order_id`, `quantity_sold`, `unit_price`, `total_price`, `commission_rate`, `commission_amount`, `sale_date`, `Status`, `Notes`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 25000000.00, 25000000.00, 8.00, 2000000.00, '2025-08-20 10:00:00', 'completed', 'Máy cày bán cho khách hàng 1', '2025-08-20 10:00:00', '2025-08-24 14:30:00'),
(2, 3, 2, 3, 80000.00, 240000.00, 5.00, 12000.00, '2025-08-21 09:00:00', 'shipped', 'Hạt giống corn bán cho khách hàng 2', '2025-08-21 09:00:00', '2025-08-21 15:00:00'),
(3, 4, 2, 50, 45000.00, 2250000.00, 6.00, 135000.00, '2025-08-21 09:00:00', 'shipped', 'Phân bón bán kèm hạt giống', '2025-08-21 09:00:00', '2025-08-21 15:00:00'),
(4, 5, 3, 1, 12000000.00, 12000000.00, 10.00, 1200000.00, '2025-08-21 11:00:00', 'confirmed', 'Drone phun thuốc cho nông dân 1', '2025-08-21 11:00:00', '2025-08-21 11:30:00');
...
(1, 1, 7, 'Kinh nghiệm trồng lúa hữu cơ năm 2025', 'kinh-nghiem-trong-lua-huu-co-nam-2025', '{"content": "Xin chia sẻ kinh nghiệm trồng lúa hữu cơ của tôi sau 5 năm thực hiện. Từ việc chuẩn bị đất, chọn giống, đến chăm sóc và thu hoạch..."}', '["lúa hữu cơ", "kinh nghiệm", "canh tác bền vững"]', 156, 3, 12, 0, 1, 0, 'published', NULL, NULL, '2025-08-21 08:00:00', '2025-08-20 14:00:00', '2025-08-21 08:00:00'),
(2, 2, 8, 'Đánh giá máy cày mini điện VerdantTech V1', 'danh-gia-may-cay-mini-dien-verdanttech-v1', '{"content": "Vừa mua máy cày mini điện này để dùng cho trang trại 2ha của mình. Sau 1 tuần sử dụng, tôi có một số nhận xét..."}', '["máy cày", "điện", "đánh giá", "VerdantTech"]', 89, 2, 8, 0, 0, 0, 'published', NULL, NULL, '2025-08-21 07:30:00', '2025-08-20 16:00:00', '2025-08-21 07:30:00'),
(3, 1, 5, 'Hỏi về cách phòng chống sâu bệnh tự nhiên', 'hoi-ve-cach-phong-chong-sau-benh-tu-nhien', '{"content": "Mình mới bắt đầu trồng rau hữu cơ, muốn hỏi anh chị có kinh nghiệm về cách phòng chống sâu bệnh mà không dùng thuốc hóa học không?"}', '["sâu bệnh", "hữu cơ", "phòng trừ tự nhiên"]', 67, 1, 5, 0, 0, 0, 'published', NULL, NULL, '2025-08-21 10:00:00', '2025-08-21 09:00:00', '2025-08-21 09:00:00'),
(4, 3, 6, 'Cách ủ phân compost hiệu quả tại nhà', 'cach-u-phan-compost-hieu-qua-tai-nha', '{"content": "Chia sẻ cách ủ phân compost từ rác thải nhà bếp và lá cây hiệu quả, giúp tiết kiệm chi phí phân bón..."}', '["compost", "phân hữu cơ", "tự làm"]', 124, 0, 7, 0, 0, 0, 'published', NULL, NULL, '2025-08-21 10:00:00', '2025-08-21 10:00:00', '2025-08-21 10:00:00');
...
-- Insert Payments (NEW TABLE)
INSERT INTO `payments` (`Id`, `transaction_id`, `amount`, `payment_method`, `gateway_transaction_id`, `Status`, `metadata`, `processed_at`, `created_at`, `updated_at`) VALUES
(1, 1, 23000000.00, 'vnpay', 'VNP_TX_20250820001', 'completed', '{"gateway": "vnpay", "bank_code": "NCB", "card_type": "ATM"}', '2025-08-20 11:30:00', '2025-08-20 11:30:00', '2025-08-20 11:30:00'),
(2, 2, 1483500.00, 'momo', 'MOMO_TX_20250821001', 'completed', '{"gateway": "momo", "phone": "0901234572"}', '2025-08-21 09:15:00', '2025-08-21 09:15:00', '2025-08-21 09:15:00'),
(3, 3, 11240000.00, 'bank_transfer', 'BANK_TX_20250821001', 'pending', '{"gateway": "bank", "account": "VCB123456789", "reference": "VDT20250821"}', NULL, '2025-08-21 11:00:00', '2025-08-21 11:00:00');

-- Insert Cashouts (NEW TABLE)
INSERT INTO `cashouts` (`Id`, `transaction_id`, `user_id`, `amount`, `bank_code`, `bank_account_number`, `bank_account_holder`, `Status`, `metadata`, `requested_at`, `processed_at`, `created_at`, `updated_at`) VALUES
(1, 4, 1, 2000000.00, 'VCB', '1234567890', 'Công Ty Thiết Bị Nông Nghiệp Xanh', 'pending', '{"commission_source": "product_sales", "products": [1]}', '2025-08-24 15:30:00', NULL, '2025-08-24 15:30:00', '2025-08-24 15:30:00'),
(2, 5, 2, 147000.00, 'TCB', '0987654321', 'Cửa Hàng Nông Sản Sạch VerdantTech', 'completed', '{"commission_source": "product_sales", "products": [3,4]}', '2025-08-21 16:30:00', '2025-08-22 10:00:00', '2025-08-21 16:30:00', '2025-08-22 10:00:00');