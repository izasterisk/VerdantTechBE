...
CREATE TABLE media_links (
    ...
    purpose ENUM('front', 'back', 'none', 'productcertificatepdf', 'vendorCertificatesPdf') DEFAULT 'none' COMMENT 'Mục đích của hình ảnh: front (ảnh chính), back (ảnh phụ), none (không xác định), productcertificatepdf (PDF chứng chỉ sản phẩm), vendorCertificatesPdf (PDF chứng chỉ vendor)',
