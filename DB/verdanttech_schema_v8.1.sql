...
CREATE TABLE orders (
    ...
    notes VARCHAR(500),
    courier_id VARCHAR(20) REQUIRED COMMENT 'Mã đơn vị vận chuyển/nhà cung cấp vận chuyển',
    width INT REQUIRED COMMENT 'Chiều rộng gói hàng (cm)',
    height INT REQUIRED COMMENT 'Chiều cao gói hàng (cm)',
    length INT REQUIRED COMMENT 'Chiều dài gói hàng (cm)',
    weight INT REQUIRED COMMENT 'Cân nặng gói hàng (gram)',
