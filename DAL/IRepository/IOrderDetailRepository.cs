...
public interface IOrderDetailRepository
{
    ...
    Task<List<ProductSerial>> GetAllProductSerialAsync(Dictionary<string, (string lotNumber, ulong productId)> validateSerialNumber, CancellationToken cancellationToken = default);
}