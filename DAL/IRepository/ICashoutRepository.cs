...
public interface ICashoutRepository
{
    ...
    Task<Cashout> CreateRefundCashoutWithTransactionAsync(Cashout cashout, Transaction tr, Order order, List<OrderDetail> orderDetails, CancellationToken cancellationToken = default);
