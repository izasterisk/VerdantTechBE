...
public interface ICashoutRepository
{
    ...
    Task<Cashout> CreateRefundCashoutWithTransactionAsync(Cashout cashout, Transaction tr, Order order, List<ProductSerial> serialIds, CancellationToken cancellationToken = default);
