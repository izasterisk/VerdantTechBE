...
public interface IFarmProfileRepository
{
    ...
    Task<FarmProfile> GetFarmWithAddressByFarmIdAsync(ulong farmId, bool useNoTracking = true, CancellationToken cancellationToken = default);
    ...
    Task<List<FarmProfile>> GetAllFarmWithAddressByUserIdAsync(ulong userId, bool useNoTracking = true, CancellationToken cancellationToken = default);
